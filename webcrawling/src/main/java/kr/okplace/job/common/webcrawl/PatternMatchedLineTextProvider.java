 ...
 * @author Superman
 */
public class PatternMatchedLineTextProvider extends PatternMatcherWrapper implements TextProvider {

	private static final Log log = LogFactory.getLog(PatternMatchedLineTextProvider.class);
