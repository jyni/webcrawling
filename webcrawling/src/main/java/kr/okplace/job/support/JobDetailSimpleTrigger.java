...
public class JobDetailSimpleTrigger extends SimpleTriggerImpl implements SimpleTrigger, InitializingBean, ApplicationContextAware {
...
//		Assert.notNull(group, "Property[group] required!");
		...
		super.setName(jobName + "DetailSimpleTrigger");
